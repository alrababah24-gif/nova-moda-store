...
export function Hero({
  ...
  return (
    <section className="identity-hero relative overflow-hidden border-b border-[var(--line)]">
      ...
      <div className="identity-hero-word" aria-hidden="true">
        NOVA
      </div>
      ...
      <div className="container-shell relative grid min-h-[650px] items-center gap-8 py-12 lg:grid-cols-[1.04fr_.96fr] lg:py-16">
        ...
        >
          ...
          <div className="hero-actions">
            <Link href="/shop" className="hero-action-primary">
              {settings.hero_primary_cta}
              <ArrowUpLeft size={16} />
            </Link>

            <Link href="/brands" className="hero-action-secondary">
              اكتشفي البراندات
            </Link>
          ...
          <div className="hero-signature-line">
            <span>قصّات محسوبة</span>
            <i />
            <span>خامات مختارة</span>
            <i />
        ...
        >
          <div className="hero-fashion-frame">
            ...
            <motion.div
              animate={
                reduce ? undefined : { y: [0, 7, 0], rotate: [0, 1, 0] }
              }
              transition={{
                duration: 7.2,
                repeat: Infinity,
